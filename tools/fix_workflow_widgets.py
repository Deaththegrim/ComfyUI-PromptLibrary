...
_CURRENT_WIDGETS = [
    ...
    ("skin_max",            "int",    0),
    ("skin_steps",          "int",    0),
    ("mouth_threshold",     "float",  -1.0),
    ("mouth_denoise",       "float",  -1.0),
    ("mouth_max",           "int",    0),
    ("mouth_steps",         "int",    0),
    ("feet_threshold",      "float",  -1.0),
    ("feet_denoise",        "float",  -1.0),
    ("feet_max",            "int",    0),
    ("feet_steps",          "int",    0),
    ("face_crop_factor",    "float",  0.0),
    ("eyes_crop_factor",    "float",  0.0),
    ("mouth_crop_factor",   "float",  0.0),
    ("hands_crop_factor",   "float",  0.0),
    ("feet_crop_factor",    "float",  0.0),
    ("skin_crop_factor",    "float",  0.0),
